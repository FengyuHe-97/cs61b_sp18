...
public class Rasterer {
    ...
    double lrlon, ullon, w, h, ullat, lrlat, LonDPP, maxLon;
    int rowLeft, rowRight, columnUp, columnDown;
    String[][] render_grid;
    int depth;
    ...
    public Map<String, Object> getMapRaster(Map<String, Double> params) {
        ...
        if (ullon < MapServer.ROOT_ULLON) {
            ...
            rowLeft = (int) Math.floor((ullon - MapServer.ROOT_ULLON) / lonPerTile);
        }
        //计算一行中最右端Tile的坐标
        ...
        if (ullat > MapServer.ROOT_ULLAT) {
            ...
            columnUp = (int) Math.floor((MapServer.ROOT_ULLAT - ullat) / latPerTile);
        }
        //计算一列中最下方Tile的坐标
        columnDown = (int) (Math.pow(2, depth) - 1 - Math.floor((lrlat
